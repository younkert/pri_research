...
#' [Isolate survival data]
surv_data <- full_data[,.(case_id, gene, 
                          DAYS_LAST_FOLLOWUP, 
                          disease_free_MONTHS_since_trtmnt = DFS_MONTHS, 
                          disease_free_STATUS_since_trtmnt = DFS_STATUS, 
                          disease_spec_survival_MONTHS = DSS_MONTHS, 
                          disease_spec_survival_STATUS = DSS_STATUS, 
                          overall_survival_MONTHS = OS_MONTHS, 
                          overall_survival_STATUS = OS_STATUS, 
                          progress_free_surv_MONTHS = PFS_MONTHS,
                          progress_free_surv_STATUS = PFS_STATUS)]
