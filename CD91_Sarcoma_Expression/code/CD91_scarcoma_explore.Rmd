...
![cBioPortal LRP1 expression figure.](/Users/Teddy/R/repos/pri_research/CD91_Sarcoma_Expression/images/Screen Shot 2019-06-20 at 1.05.22 PM.png){width=250}
<br />
<br />
...
RNAseq_profile_data <- getProfileData.CGDS(x = mycgds, 
                                           genes = c('LRP1','CD3E','CD8A','FOXP3','NCAM'), 
...
setnames(x = RNAseq_profile_data, old = "NCAM", new = "NCAM_mrna_TPM")
